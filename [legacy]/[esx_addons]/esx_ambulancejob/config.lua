...
Config.EarlyRespawnTimer          = 15000 * 1  -- time til respawn is available
Config.BleedoutTimer              = 30000 * 10 -- time til the player bleeds out
...
Config.RespawnPoint = {coords = vector3(-498.97, -335.7, 34.5), heading = 257.53}
...
Config.Hospitals = {
	...
	CentralLosSantos = {
		...
		Blip = {
			coords = vector3(-471.45, -324.3, 34.36),
			sprite = 61,
			scale  = 1.2,
			color  = 2
		},
