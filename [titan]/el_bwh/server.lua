ESX = nil
local discord_webhook = "https://discord.com/api/webhooks/918232579176538172/yd8g3lUJUL-6Dy2ULJ2BNsOSLW5Y-qxLqLeuRlVGV3Sam3yMB6fLM6zrTJL2wYkI0TKh" -- paste your discord webhook between the quotes if you want to enable discord logs.
...
Citizen.CreateThread(function() -- startup
    ...
    sendToDiscord("el_bwh zostal odpalony (tak neslak tylko dla ciebie zrobilem to potwierdzenie)...")
